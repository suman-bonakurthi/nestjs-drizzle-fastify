...
import { OrganizationUsersSeedData } from '../data/organization-users';
import { BaseSeeder } from './base.seeder';

@Injectable()
// Extend the new BaseSeeder class
export class OrganizationUsersSeeder extends BaseSeeder<
  typeof schema.organizationUsers
> {
  // 1. Define the specific schema table
  protected readonly schemaTable = schema.organizationUsers;

  // 2. Define the specific data array
  protected readonly seedData = OrganizationUsersSeedData;
