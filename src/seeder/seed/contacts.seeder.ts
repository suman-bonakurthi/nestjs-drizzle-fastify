...
import { ContactsSeedData } from '../data/contacts';
import { BaseSeeder } from './base.seeder';

@Injectable()
// Extend the new BaseSeeder class
export class ContactsSeeder extends BaseSeeder<typeof schema.contacts> {
  // 1. Define the specific schema table
  protected readonly schemaTable = schema.contacts;

  // 2. Define the specific data array
  protected readonly seedData = ContactsSeedData;
